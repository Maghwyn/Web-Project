...
const Articles = (props) => {
  ...
  // console.log(props);
  const opinionsArray = props.opinionsArray;
  const searchOkay = props.foundPublication;

  // const sendOpinions =
  // opinionsArray.map((opinion) => {
  //   props.fetchArrayPublications.extend(opinion)
  // })
  // console.log(props.fetchArrayPublications);

  // const arrayToFusion = () => {
  //   props.fetchArrayPublications.filter((data, index) => {
  //      setArray(data);
  //   })
  // }
  ...
  const addDislikes = () => {
    return (
      <div>
        ...
        >
          <g
            id="thumb_down_android_app_aplication_phone"
  ...
  const printPublicationsFetched = props.fetchArrayPublications.map(
    (data, index) => {
      // opinionsArray.filter((opinions, index) => {
